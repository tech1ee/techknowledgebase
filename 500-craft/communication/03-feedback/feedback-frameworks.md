...
> **Фреймворк обратной связи** — структурированная модель, задающая последовательность шагов для предоставления feedback, минимизирующая субъективность и defensiveness получателя. Каждый фреймворк оптимизирован под конкретную цель: коррекция, развитие, установка границ или оценка.

### Академические корни ключевых моделей

| Фреймворк | Авторы/организация | Год | Теоретическая основа |
|-----------|--------------------|-----|---------------------|
| **SBI** | Center for Creative Leadership (CCL) | 1996 | Behavioral observation theory — feedback о поведении, не о личности |
| **Johari Window** | Joseph Luft, Harrington Ingham | 1955 | Модель самосознания: open/blind/hidden/unknown зоны → feedback расширяет open area |
| **DESC** | Sharon Bower, Gordon Bower | 1976 | Assertiveness training; книга «Asserting Yourself» |
| **STAR** | Development Dimensions International (DDI) | 1970-е | Behavioral Event Interview (McClelland, 1973) → structured evidence-based assessment |
| **COIN** | Anna Carroll | 2010-е | Интеграция observation-based feedback с action-oriented coaching |
| **CEDAR** | Training industry | 2010-е | Collaborative coaching модели, двусторонний dialogue |
| **Radical Candor** | Kim Scott | 2017 | Матрица 2×2: Care Personally × Challenge Directly |

### Johari Window как теоретический фундамент

Джозеф Лафт и Гарри Ингхэм (1955) предложили модель, объясняющую *зачем* feedback необходим:

```
           Known to Self    Unknown to Self
          ┌────────────────┬────────────────┐
Known to  │   OPEN AREA    │   BLIND SPOT   │
Others    │  (общее знание) │  (видят другие) │
          ├────────────────┼────────────────┤
Unknown   │   HIDDEN AREA  │   UNKNOWN      │
to Others │  (скрываю сам)  │  (никто не знает)│
          └────────────────┴────────────────┘
```

> **Feedback** расширяет Open Area за счёт Blind Spot: коллеги видят то, что ты не замечаешь в своём поведении. **Self-disclosure** расширяет Open Area за счёт Hidden Area. Цель эффективного feedback — максимизация Open Area.

### Growth Mindset и feedback (Dweck, 2006)

Carol Dweck в работе «Mindset: The New Psychology of Success» (2006) показала, что реакция на feedback определяется установкой:

| Установка | Реакция на feedback | Следствие |
|-----------|-------------------|-----------|
| **Fixed mindset** | «Критика = я плохой» | Defensiveness, avoidance |
| **Growth mindset** | «Критика = возможность роста» | Openness, action |

Это объясняет, почему фреймворки, фокусирующиеся на **поведении** (SBI: «ты сделал X»), а не на **личности** («ты такой-то»), более эффективны — они позволяют получателю оставаться в growth mindset.

### Связь между фреймворками

Все пять фреймворков — точки на спектре от **directive** до **collaborative** feedback. Выбор зависит от зрелости отношений (trust level), сложности ситуации и доступного времени. См. [[giving-feedback]] для базовых принципов и [[receiving-feedback]] для второй стороны процесса.
...
|---|----------|-----|-----------|
| 1 | Luft J., Ingham H. The Johari Window: A Graphic Model of Interpersonal Awareness // Proceedings of the Western Training Laboratory, 1955 | Оригинальная статья | Johari Window, зоны самосознания |
| 2 | Bower S.A., Bower G.H. Asserting Yourself. Addison-Wesley, 1976 | Монография | DESC-модель, assertiveness training |
| 3 | McClelland D.C. Testing for Competence Rather Than for Intelligence // American Psychologist, 1973 | Статья | Behavioral Event Interview → основа STAR |
| 4 | Dweck C.S. Mindset: The New Psychology of Success. Random House, 2006 | Монография | Fixed vs. growth mindset, реакция на feedback |
| 5 | Scott K. Radical Candor. St. Martin's Press, 2017 | Монография | Care Personally × Challenge Directly |

...
> **Media Richness Theory** (Daft & Lengel, 1986) — теория, утверждающая что эффективность коммуникации зависит от соответствия «богатства» канала сложности задачи. В контексте remote work дополняется **Media Synchronicity Theory** (Dennis & Valacich, 1999) и **Trust Equation** (Maister, Green & Galford, 2000).

### Историческая хронология

| Год | Автор / Событие | Вклад |
|-----|-----------------|-------|
| 1986 | Daft & Lengel | Media Richness Theory — face-to-face > video > phone > email > document |
| 1999 | Dennis & Valacich | Media Synchronicity Theory — conveyance (async) vs convergence (sync) |
| 2000 | Maister, Green & Galford | *The Trusted Advisor* — Trust = (Credibility + Reliability + Intimacy) / Self-Orientation |
| 2002 | J. Richard Hackman | *Leading Teams* — условия эффективности команд, включая virtual |
| 2013 | Basecamp (Fried & Hansson) | *Remote: Office Not Required* — первый манифест remote-first |
| 2014 | Nicholas Bloom (Stanford) | Эксперимент с Ctrip: remote workers на 13% продуктивнее |
| 2021 | GitLab | Открытый Remote Work Handbook — 2000+ страниц практик |

### Trust Equation в remote-контексте

Maister, Green & Galford (2000) формализовали доверие как:
...
| Компонент | Офис | Remote | Решение |
|-----------|------|--------|---------|
| **Credibility** | Видно по работе | Сложнее показать | Документировать достижения, knowledge sharing |
| **Reliability** | Присутствие = работа | Невидимость | «Working out loud», overcommunicate progress |
| **Intimacy** | Случайные встречи | Изоляция | Intentional rituals (coffee chat, Donut bot) |
| **Self-Orientation** | Наблюдаемо | «Он вообще работает?» | Output-based management, не surveillance |

Bloom (2014) в эксперименте со Ctrip (16,000 сотрудников) доказал: remote workers на **13% продуктивнее**, но 50% хотели вернуться в офис из-за isolation. Это подтверждает необходимость третьего столпа — Connection Rituals.

Media Richness Theory объясняет Communication Architecture: handbook (low richness, high persistence) > async long-form > async quick > sync meetings (high richness, low persistence). Каждый уровень оправдан для своего типа задачи: sync meetings — для convergence (решения, отношения), async — для conveyance (информация, reference).

> Связь с другими материалами: [[async-communication]] описывает принципы async-first коммуникации, [[cultural-dimensions]] объясняет как культурный контекст влияет на remote-взаимодействие, [[giving-feedback]] требует адаптации для remote (текст лишён тона → видео для sensitive feedback).
...
| 2 | Maister, D., Green, C. & Galford, R. *The Trusted Advisor*. Free Press, 2000 | Монография |
| 3 | Bloom, N. et al. "Does Working from Home Work?" *Quarterly Journal of Economics*, 130(1), 2015 | Статья |
| 4 | Hackman, J. R. *Leading Teams*. Harvard Business Press, 2002 | Монография |
| 5 | Dennis, A. R. & Valacich, J. S. "Rethinking Media Richness". *HICSS*, 1999 | Статья |
...
| 4 | Zapier's Guide to Remote Work | Гайд |
| 5 | Berkun, S. *The Year Without Pants*. Jossey-Bass, 2013 | Книга |
| 6 | Newport, C. *A World Without Email*. Portfolio, 2021 | Книга |
| 7 | Harvard Business Review — Remote work research | Статьи |

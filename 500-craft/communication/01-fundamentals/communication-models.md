...
> **Коммуникация** (лат. *communicatio* — «связь, сообщение») — процесс обмена информацией между участниками с целью достижения взаимопонимания. В теории информации определяется как передача сигнала от источника к получателю через канал при наличии шума (Shannon & Weaver, 1949).

### Хронология ключевых моделей

| Год | Модель | Авторы | Ключевая идея |
|-----|--------|--------|---------------|
| 1948 | Mathematical Theory of Communication | Claude Shannon, Warren Weaver | Линейная передача сигнала, понятие шума и ёмкости канала |
| 1954 | Модель Osgood—Schramm | Charles Osgood, Wilbur Schramm | Циклическая коммуникация, оба участника — и кодировщики, и декодировщики |
| 1960 | SMCR Model | David Berlo | Учёт характеристик отправителя и получателя (skills, attitudes, knowledge, social system, culture) |
| 1970 | Transactional Model | Dean Barnlund | Одновременное кодирование/декодирование, shared field of experience |
| 1975 | Coordinated Management of Meaning | W. Barnett Pearce, Vernon Cronen | Коммуникация как совместное конструирование социальной реальности |

### Академический контекст

Работа Шеннона и Уивера «A Mathematical Theory of Communication» (1948) была изначально инженерной — описывала передачу электрических сигналов в Bell Labs. Уоррен Уивер расширил модель на human communication, введя три уровня проблем:

1. **Технический уровень** — насколько точно символы могут быть переданы?
2. **Семантический уровень** — насколько точно переданные символы передают желаемое значение?
3. **Прагматический уровень** — насколько эффективно полученное значение влияет на поведение?

> **Ключевой вклад Шеннона** — формализация понятия *информационной энтропии* (H = −Σ p(x) log₂ p(x)), которая количественно измеряет неопределённость в сообщении. Это позволило перейти от интуитивного к математическому описанию коммуникации.

Дин Барнлунд в работе «A Transactional Model of Communication» (1970) критиковал линейные модели за три допущения: (1) коммуникация однонаправлена, (2) получатель пассивен, (3) контекст не влияет на смысл. Его транзакционная модель стала основой современного понимания межличностной коммуникации в организационной психологии.

### Связь с информатикой

Модель Шеннона—Уивера прямо повлияла на проектирование сетевых протоколов: модель OSI (ISO 7498, 1984) воспроизводит логику «источник → кодирование → канал → декодирование → получатель» на каждом из семи уровней. Понятия [[cognitive-load-theory|когнитивной нагрузки]] и [[communication-barriers|коммуникационных барьеров]] являются прямыми аналогами шеннновского «шума» применительно к человеческому восприятию.
...
|---|----------|-----|-----------|
| 1 | Shannon C.E. A Mathematical Theory of Communication // Bell System Technical Journal, 1948. Vol. 27. P. 379–423 | Оригинальная статья | Математическая модель коммуникации, понятие энтропии |
| 2 | Shannon C.E., Weaver W. The Mathematical Theory of Communication. University of Illinois Press, 1949 | Монография | Расширение модели на human communication, три уровня проблем |
| 3 | Berlo D.K. The Process of Communication. Holt, Rinehart & Winston, 1960 | Монография | SMCR-модель, факторы источника и получателя |
| 4 | Barnlund D.C. A Transactional Model of Communication // Foundations of Communication Theory. Harper & Row, 1970 | Глава в книге | Транзакционная модель, shared field of experience |
| 5 | Schramm W. How Communication Works // The Process and Effects of Mass Communication. University of Illinois Press, 1954 | Глава в книге | Циклическая модель, Osgood—Schramm |

...
> **Доставка плохих новостей** (bad news delivery) — коммуникативный акт передачи информации, которая негативно влияет на ожидания, планы или благополучие получателя. Исследования показывают, что *способ* доставки влияет на реакцию получателя не меньше, чем *содержание* самого сообщения (Sweeny & Shepperd, 2007).

### Протокол SPIKES (Baile et al., 2000)

Онколог Walter Baile с коллегами разработали протокол SPIKES для сообщения диагнозов пациентам. Модель была адаптирована для организационного контекста:

| Шаг | Расшифровка | Организационный контекст |
|-----|-------------|-------------------------|
| **S** — Setting | Подготовь обстановку | Приватная комната, не email/Slack, достаточно времени |
| **P** — Perception | Пойми что человек уже знает | «Как ты видишь текущую ситуацию с проектом?» |
| **I** — Invitation | Получи разрешение | «Мне нужно сообщить важную информацию» |
| **K** — Knowledge | Сообщи факты | Прямо, без эвфемизмов: «Проект закрывается» |
| **E** — Emotions | Отреагируй на эмоции | [[empathetic-listening|Эмпатическое слушание]], validation |
| **S** — Strategy/Summary | Следующие шаги | Конкретный план: что происходит дальше |

### MUM-эффект (Rosen & Tesser, 1970)

> **MUM-эффект** (Mum about Undesirable Messages) — психологическая тенденция людей избегать сообщения плохих новостей. Rosen & Tesser (1970) экспериментально показали, что люди систематически откладывают, смягчают или делегируют доставку негативной информации, даже когда задержка ухудшает ситуацию.

В IT-контексте MUM-эффект проявляется как:
- Разработчик не сообщает о срыве дедлайна до последнего момента
- Менеджер откладывает разговор о низком performance
- Тимлид избегает эскалации блокеров

### Теория справедливости в организационном контексте

Исследования organizational justice (Colquitt, 2001) показывают, что восприятие *процедурной справедливости* (как решение было принято и сообщено) влияет на реакцию сильнее, чем *дистрибутивная справедливость* (само решение):

| Тип справедливости | Влияние на восприятие bad news |
|-------------------|-------------------------------|
| **Procedural** (процесс) | Понятна ли логика решения? Был ли голос? |
| **Interactional** (взаимодействие) | С уважением ли сообщили? Были ли честны? |
| **Distributive** (результат) | Справедливо ли само решение? |

> Даже несправедливое решение воспринимается мягче, если процесс и коммуникация были справедливыми. Именно поэтому *как* ты сообщаешь плохие новости важнее *что* ты сообщаешь.
...
|---|----------|-----|-----------|
| 1 | Baile W.F. et al. SPIKES — A Six-Step Protocol for Delivering Bad News // The Oncologist, 2000. Vol. 5(4). P. 302–311 | Оригинальная статья | Протокол SPIKES |
| 2 | Rosen S., Tesser A. On reluctance to communicate undesirable information: The MUM effect // Sociometry, 1970 | Статья | MUM-эффект |
| 3 | Sweeny K., Shepperd J.A. Being the Best Bearer of Bad Tidings // Review of General Psychology, 2007 | Обзор | Стратегии доставки плохих новостей |
| 4 | Colquitt J.A. On the dimensionality of organizational justice // Journal of Applied Psychology, 2001 | Статья | Процедурная, интеракционная и дистрибутивная справедливость |

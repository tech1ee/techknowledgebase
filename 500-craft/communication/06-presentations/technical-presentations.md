...
> **Когнитивная теория мультимедийного обучения** (Cognitive Theory of Multimedia Learning, CTML) — теория Ричарда Майера (2001), согласно которой люди обучаются эффективнее из слов и изображений одновременно, чем только из слов, при условии соблюдения принципов когнитивной нагрузки.

### Историческая хронология

| Год | Автор / Событие | Вклад |
|-----|-----------------|-------|
| 1956 | George Miller | «Магическое число 7±2» — ёмкость рабочей памяти |
| 1967 | Barbara Minto | Pyramid Principle в McKinsey — структура «главное вперёд» |
| 1969 | Allan Paivio | Dual Coding Theory — два канала обработки (вербальный + визуальный) |
| 1988 | John Sweller | [[cognitive-load-theory]] — intrinsic, extraneous, germane load |
| 2001 | Richard Mayer | CTML — 12 принципов мультимедийного обучения |
| 2006 | Guy Kawasaki | Правило 10-20-30 для презентаций |
| 2008 | Nancy Duarte | «slide:ology» — визуальный сторителлинг |

### Три типа когнитивной нагрузки в презентациях

Согласно Sweller (1988) и Mayer (2001), эффективность презентации определяется балансом трёх нагрузок:

| Тип нагрузки | Определение | Пример в презентации |
|--------------|-------------|----------------------|
| **Intrinsic** | Сложность самого материала | Объяснение CAP-теоремы |
| **Extraneous** | Нагрузка от плохого оформления | Мелкий шрифт, wall of text, 3D-графики |
| **Germane** | Нагрузка на осмысление и интеграцию | Аналогии, связи с предыдущим опытом |

Minto Pyramid Principle минимизирует extraneous load: когда аудитория сразу знает вывод, она организует детали вокруг известной структуры, а не удерживает их «на весу». Это напрямую следует из Primacy Effect (Murdock, 1962) — информация, услышанная первой, запоминается лучше.

Rule of Three основан на ограничении рабочей памяти: Cowan (2001) уточнил Miller до **4±1 элементов**, что делает 3 supporting points оптимальным количеством. Четыре и более аргументов вызывают **dilution effect** (Nisbett et al., 1981) — сильные аргументы «размываются» слабыми.

> Связь с другими материалами: [[cognitive-load-theory]] объясняет научную базу Rule of Three и progressive disclosure, [[presentation-design]] применяет принципы CTML к визуальному оформлению слайдов, [[storytelling-tech]] использует neural coupling для удержания внимания аудитории.
...
| 2 | Minto, B. *The Minto Pyramid Principle*. Minto International, 1967/2009 | Монография |
| 3 | Sweller, J. "Cognitive Load During Problem Solving". *Cognitive Science*, 12(2), 1988 | Статья |
| 4 | Cowan, N. "The Magical Number 4 in Short-Term Memory". *Behavioral and Brain Sciences*, 24(1), 2001 | Статья |
| 5 | Murdock, B. B. "The Serial Position Effect of Free Recall". *Journal of Experimental Psychology*, 64(5), 1962 | Статья |
...
> [!question]- Вы готовите architecture review на 15 минут. У вас 7 аргументов в пользу предложенного решения. Как вы структурируете презентацию по Minto Pyramid и Rule of Three? Что делать с оставшимися 4 аргументами?
> Начните с main point (рекомендация), затем выберите 3 самых сильных supporting point. Остальные 4 аргумента вынесите в appendix / hidden slides. По Rule of Three, после 3 аргументов credibility падает — аудитория начинает сомневаться в основной идее. Оставшиеся аргументы пригодятся при Q&A, если будут уточняющие вопросы.

> [!question]- Почему Minto Pyramid рекомендует давать главную мысль первой, а не строить к ней постепенно, как привычно большинству инженеров?
> Потому что внимание аудитории максимально в первые 10 секунд и резко падает после 10 минут. Если вывод «закопан» в конце (buried lead), stakeholders теряют нить и не понимают, зачем слушать детали. Minto Pyramid отражает принцип «думаем снизу вверх, но презентуем сверху вниз» — аудитория сразу получает answer и может оценивать supporting points в контексте уже известного решения.

> [!question]- Вы делаете live demo нового feature, и приложение зависает на глазах у 30 человек. Опишите пошаговую стратегию recovery, используя принципы из этого материала и знания о когнитивной нагрузке ([[cognitive-load-theory]]).
> 1) Acknowledge — спокойно: «Окей, это не то что ожидал. Секунду.» 2) Quick fix — не более 30 секунд, чтобы не перегружать когнитивную нагрузку аудитории ожиданием. 3) Switch to backup — recorded video или diagram. 4) Move on — вернитесь к narrative. Главное — не паниковать и не говорить «это обычно работает». С точки зрения когнитивной нагрузки, длинная пауза и debug на сцене создают extraneous load, который уничтожает внимание и мешает аудитории удерживать germane load (вашу основную идею).

> [!question]- Коллега подготовил tech talk: 20 слайдов текста по 12pt, начинает с «Меня зовут...», демо не тестировал. Проанализируйте, какие конкретные ошибки из раздела «Распространённые ошибки» он допускает и какие slide design rules нарушает.
> Ошибки: 1) Buried lead — начинает с представления, а не с hook. 2) Reading slides — 20 слайдов текста подталкивают к чтению. 3) No practice — нет протестированного demo. Нарушения slide design: «минимум текста» (полные предложения вместо keywords), «крупный шрифт» (12pt вместо 24pt+), «one idea per slide» (вероятно, несколько идей на слайде). Рекомендация: перестроить по SCQA, сократить до 10 слайдов с диаграммами, увеличить шрифт, отрепетировать 2-3 раза.

---

## Ключевые карточки

Minto Pyramid — как структурировать техническую презентацию?
?
Главное первым (answer/recommendation), затем 3 supporting points, затем details и evidence. «Думаем снизу вверх, но презентуем сверху вниз.»

SCQA Framework — расшифруйте и приведите пример.
?
Situation (контекст) → Complication (проблема) → Question (вопрос, implicit) → Answer (решение). Пример: S: «100K DAU на monolith», C: «при 500K response time деградирует на 300%», Q: «как масштабировать?», A: «микросервисы + план».

Rule of Three — почему именно 3 аргумента, а не 5?
?
После 3 supporting points credibility начинает падать из-за когнитивной нагрузки. 4+ аргументов вызывают сомнение: «если нужно столько обоснований, возможно основная идея слабая».

Какова структура opening первых 30 секунд презентации?
?
1) Начать с hook (статистика / проблема / история / вопрос), НЕ с «Меня зовут...». 2) Первое предложение выучить наизусть. Цель — захватить внимание в первые 10 секунд.

Как обработать hostile question на Q&A?
?
Stay calm → acknowledge concern → address specific facts, не защищаться → спросить «Какие конкретные concerns остаются?». Никогда: «Нет, вы не понимаете».

Что делать если live demo упало?
?
1) Acknowledge (спокойно). 2) Quick fix — max 30 секунд. 3) Switch to backup (recorded video или diagram). 4) Move on. Никогда не говорить «это обычно работает».

Назовите 5 правил slide design.
?
1) One idea per slide. 2) Минимум текста — keywords, не предложения. 3) Крупный шрифт: 24pt+ body, 36pt+ titles. 4) Высокий контраст. 5) Визуализация: диаграммы вместо текстовых описаний.

Architecture Review — из каких 7 блоков состоит структура?
?
1) Context (2 мин) → 2) Proposal + diagram (5 мин) → 3) Alternatives considered (3 мин) → 4) Risks & mitigations (3 мин) → 5) Plan/timeline (2 мин) → 6) Ask — что нужно от аудитории (1 мин) → 7) Q&A (10-15 мин).
...
|-------------|------|-------|
| Дизайн слайдов | [[presentation-design]] | Продвинутые техники визуального оформления слайдов |
| Сторителлинг | [[storytelling-tech]] | Как строить narrative в технических докладах |
| Активное слушание | [[active-listening]] | Фундамент для эффективного Q&A handling |
| Обратная связь | [[giving-feedback]] | Навык для architecture reviews и code review presentations |
| Когнитивная нагрузка | [[cognitive-load-theory]] | Почему Rule of Three работает и как не перегрузить аудиторию |
| Коммуникация руководителя | [[executive-communication]] | Презентации для C-level и board — следующий уровень |
| Behavioral-интервью | [[behavioral-interview]] | Использование storytelling и SCQA для ответов на интервью |

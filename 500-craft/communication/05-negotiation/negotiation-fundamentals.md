...
> **Переговоры** (negotiation) — процесс, в ходе которого две или более стороны с различающимися интересами стремятся достичь соглашения путём взаимных уступок и поиска решений. В теории игр переговоры моделируются как задача о торге (bargaining problem), формализованная Джоном Нэшем (1950).

### Основополагающие теории

| Год | Автор | Теория | Ключевой вклад |
|-----|-------|--------|---------------|
| 1944 | von Neumann, Morgenstern | Теория игр | Формальная математическая основа стратегического взаимодействия |
| 1950 | John Nash | Nash Bargaining Solution | Аксиоматическое решение задачи о торге; Нобелевская премия 1994 |
| 1960 | Thomas Schelling | Focal Points (Schelling Points) | Координация без коммуникации; «The Strategy of Conflict» |
| 1981 | Fisher, Ury | Principled Negotiation | «Getting to Yes»: интересы vs. позиции, BATNA |
| 1991 | William Ury | Overcoming resistance | «Getting Past No»: 5 барьеров в переговорах |
| 2011 | Chris Voss | Tactical Empathy | «Never Split the Difference»: FBI-техники для бизнеса |

### Nash Bargaining Solution (1950)

Джон Нэш показал, что при определённых аксиомах (симметрия, Парето-оптимальность, независимость от нерелевантных альтернатив, инвариантность к масштабированию) существует единственное рациональное решение задачи о торге:

> **Решение Нэша** максимизирует произведение выигрышей обеих сторон сверх их «точек несогласия» (disagreement points). Это математическое обоснование того, почему **win-win** не просто этический идеал, а *рациональная стратегия*.

### BATNA и ZOPA

| Понятие | Определение | Автор |
|---------|-------------|-------|
| **BATNA** (Best Alternative to a Negotiated Agreement) | Лучший вариант, если переговоры провалятся | Fisher & Ury, 1981 |
| **ZOPA** (Zone of Possible Agreement) | Диапазон, в котором возможно соглашение | Raiffa, 1982 |
| **Reservation Price** | Минимально/максимально приемлемая цена | Raiffa, 1982 |
| **Anchoring Effect** | Первое предложение «якорит» дальнейшие переговоры | Tversky & Kahneman, 1974 |

> Anchoring — одно из наиболее сильных [[cognitive-biases|когнитивных искажений]]: Tversky & Kahneman (1974) показали, что первая названная цифра смещает финальный результат даже когда она заведомо нерелевантна. В переговорах: кто первый называет число, тот «ставит якорь».

Связь с [[conflict-resolution]]: переговоры — это *метод* разрешения конфликта; TKI-стиль «Collaborating» напрямую соответствует principled negotiation.
...
|---|----------|-----|-----------|
| 1 | Nash J.F. The Bargaining Problem // Econometrica, 1950. Vol. 18(2). P. 155–162 | Оригинальная статья | Аксиоматическое решение задачи о торге |
| 2 | Fisher R., Ury W. Getting to Yes: Negotiating Agreement Without Giving In. Houghton Mifflin, 1981 | Монография | BATNA, principled negotiation |
| 3 | Raiffa H. The Art and Science of Negotiation. Harvard University Press, 1982 | Монография | ZOPA, reservation price |
| 4 | Tversky A., Kahneman D. Judgment under Uncertainty: Heuristics and Biases // Science, 1974 | Статья | Anchoring effect |
| 5 | Voss C. Never Split the Difference. Harper Business, 2016 | Монография | Tactical empathy, FBI-техники |
...
| 3 | [Anchoring in Negotiation - PON](https://www.pon.harvard.edu/daily/negotiation-skills-daily/what-is-anchoring-in-negotiation/) | Article | Anchoring effect, techniques |
| 4 | [Anchoring Strategies - Red Bear](https://www.redbearnegotiation.com/blog/set-high-expectations-with-anchoring) | Article | Practical anchoring techniques |
| 5 | [Project Negotiation - APM](https://www.apm.org.uk/blog/how-to-successfully-negotiate-in-any-project/) | Article | IT project context |
| 6 | [Stakeholder Management - PMI](https://www.pmi.org/learning/library/negotiating-project-outcomes-develop-skills-6781) | Article | Stakeholder negotiation |
| 7 | [Understanding ZOPA - HBS](https://online.hbs.edu/blog/post/understanding-zopa) | Article | ZOPA deep dive |
...
> [!question]- Почему фокус на interests вместо positions приводит к лучшим результатам в переговорах? Объясни на конкретном IT-примере.
> Positions — это то, что человек заявляет ("Релиз в пятницу!"), а interests — реальная причина ("Презентация CEO в понедельник"). Когда мы копаем interests, открываются решения, невидимые на уровне позиций. Например, если PM требует релиз к пятнице (position), а реальный interest — demo для CEO, то вместо полноценного релиза можно предложить demo-ready версию или partial delivery. Позиционный торг сужает пространство до компромисса ("ладно, в понедельник"), а работа с interests расширяет ZOPA и позволяет найти win-win, сохраняя отношения.

> [!question]- PM просит добавить в спринт 4 новых задачи. Capacity команды исчерпан. Используя Iron Triangle, предложи три варианта и обоснуй каждый.
> Три переменные Iron Triangle — Scope, Time, Resources. Варианты: **(A) Scope flex** — берём 2 приоритетные задачи, остальные 2 переносим в следующий спринт (фиксируем Time + Resources). **(B) Time flex** — берём все 4 задачи, но сдвигаем deadline спринта на 3-4 дня (фиксируем Scope + Resources). **(C) Resources flex** — привлекаем дополнительного разработчика или используем pair programming, чтобы уложиться в срок с полным scope (фиксируем Scope + Time). Ключ: предложить stakeholder'у выбор tradeoff'а, а не просто сказать "нет".

> [!question]- Тебе предлагают оффер на $95K. У тебя есть данные что рыночная ставка $110-130K и альтернативный оффер на $105K. Какую стратегию anchoring и BATNA ты применишь? Опиши пошагово.
> **Шаг 1 (BATNA):** Мой BATNA — оффер $105K. Это сильная позиция: я могу уйти, если условия не устроят. **Шаг 2 (Anchor):** Называю диапазон $120-130K, обосновывая рыночными данными (levels.fyi, Glassdoor) и своим конкретным опытом. Anchor ставлю первым, потому что у меня есть data для обоснования. **Шаг 3 (ZOPA):** Мой reservation price — $110K (ниже не пойду, т.к. есть BATNA $105K + рыночные данные). Их диапазон предположительно $95-120K. ZOPA: $110-120K. **Шаг 4 (Options):** Если по salary не сходимся — расширяю ZOPA через переменные: equity, signing bonus, remote days, learning budget.

> [!question]- Как принципы Harvard Principled Negotiation пересекаются с паттерном [[conflict-resolution]]? В чём различие между negotiation и conflict resolution по целям и контексту применения?
> Пересечение: оба подхода используют принцип "отделяй людей от проблемы" и фокус на interests. Active listening критичен в обоих случаях. Однако **цели различаются**: negotiation направлен на достижение agreement по конкретному вопросу (scope, deadline, salary), а conflict resolution — на восстановление рабочих отношений и устранение эмоционального напряжения. **Контекст**: переговоры происходят до или вместо конфликта; conflict resolution — когда конфликт уже возник. Negotiation чаще оперирует данными и objective criteria, а conflict resolution сильнее опирается на эмпатию и de-escalation. На практике навыки переходят друг в друга: неудачные переговоры могут перерасти в конфликт, а грамотное разрешение конфликта часто включает элементы negotiation.

---

## Ключевые карточки

BATNA — что это и зачем нужен?
?
Best Alternative To Negotiated Agreement — лучшая альтернатива, доступная без достижения соглашения. Определяет силу позиции: сильный BATNA (другие офферы, варианты partial delivery) даёт возможность уйти; слабый BATNA вынуждает соглашаться на любые условия.

Чем position отличается от interest? Приведи пример.
?
Position — то, что человек заявляет ("Релиз к пятнице"). Interest — реальная причина ("Презентация CEO в понедельник"). Одна position может скрывать разные interests, каждый из которых ведёт к разным решениям: demo, partial delivery, feature flags.

Назови 4 принципа Harvard Principled Negotiation.
?
1) Separate people from problem — атакуй проблему, не человека. 2) Focus on interests, not positions — выясняй "почему". 3) Invent options for mutual gain — генерируй варианты вместо бинарного да/нет. 4) Use objective criteria — опирайся на данные, метрики, benchmarks.

Что такое ZOPA и как её расширить?
?
ZOPA (Zone Of Possible Agreement) — диапазон пересечения допустимых условий обеих сторон. Расширить можно: добавить переменные (remote, equity, title), изменить timeframe (staged delivery, review через 6 месяцев), найти creative options (feature flags, beta release).

Как работает anchoring и когда ставить anchor первым?
?
Первое число в переговорах задаёт точку отсчёта. Ставь anchor первым, если: у тебя есть данные для обоснования и сильный BATNA. Не ставь первым, если мало информации о другой стороне. Anchor всегда подкрепляй data: "По данным прошлых спринтов, это 7-8 дней."

Что такое Iron Triangle и как его использовать в переговорах?
?
Iron Triangle: Scope, Time, Resources — зафиксировать можно только 2 из 3. В переговорах: вместо "невозможно" предлагай tradeoff. Fix Scope + Time → Resources flex. Fix Scope + Resources → Time flex. Fix Time + Resources → Scope flex. Пусть stakeholder выбирает, какой constraint приоритетнее.

Какие 4 техники counter-anchoring существуют?
?
1) Признай, но не принимай — "Понимаю откуда цифра, но давай посмотрим на данные." 2) Переключи на criteria — "Какие критерии использовались?" 3) Re-anchor — "По нашим метрикам, реалистично X." 4) Ignore — для явно нереалистичных: "Давай сначала определим scope."

Назови 5 шагов подготовки к переговорам (Preparation Checklist).
?
1) Interests — определи свои и предполагаемые interests другой стороны. 2) BATNA — определи и по возможности усиль план B. 3) ZOPA — оцени reservation price обеих сторон. 4) Anchor — подготовь первое предложение с data-обоснованием. 5) Options — сгенерируй варианты, используя Iron Triangle.

Почему positional bargaining — ошибка? Что делать вместо этого?
?
Positional bargaining ("Нужно к пятнице" — "Только к среде" — "Ладно, к понедельнику") — торг позициями без понимания interests. Результат: suboptimal compromise, не лучшее решение. Вместо этого: выяснить interests ("Почему пятница?"), найти creative options (partial delivery, reduced scope), предложить выбор из вариантов.

Почему нужно фиксировать agreements письменно?
?
Без документации возникают разные интерпретации: "Но мы же договаривались!" Правильно: после каждого agreement — email summary, обновление Jira, meeting notes. Это защищает обе стороны и создаёт accountability.
...
|-------------|------|-------|
| Активное слушание | [[active-listening]] | Prerequisite — без умения слушать невозможно выявить interests другой стороны |
| Продвинутые frameworks | [[negotiation-frameworks]] | Углубить навык: SPIN, Chris Voss tactical empathy, multi-party negotiation |
| Stakeholder negotiation | [[stakeholder-negotiation]] | Специфика переговоров с руководством, C-level, заказчиками |
| Salary и оффер | [[negotiation]] | Применение BATNA/ZOPA/Anchoring в контексте зарплатных переговоров |
| Умение отказывать | [[saying-no]] | Как говорить "нет" scope creep без ущерба для отношений |
| Разрешение конфликтов | [[conflict-resolution]] | Когда переговоры перерастают в конфликт — de-escalation и восстановление |
| Обратная связь | [[feedback-frameworks]] | Negotiation тесно связан с умением давать и принимать feedback конструктивно |

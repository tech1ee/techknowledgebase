...
> [!question]- Почему "когнитивный долг" от AI -- это не метафора, а измеримый нейрофизиологический феномен?
> Исследование MIT Media Lab (2025) с ЭЭГ-датчиками показало: группа ChatGPT демонстрировала значимо более низкую нейронную активность при выполнении задач. 83% не смогли вспомнить ключевые тезисы своих же эссе. Корреляция r = -0.68 между частотой использования AI и критическим мышлением (Gerlich, 2025). Это буквальное снижение когнитивных способностей, а не просто лень.

> [!question]- Разработчик использует Copilot для 90% кода. Через год его перевели на проект без AI-инструментов. Какие проблемы он встретит и почему?
> Когнитивная разгрузка (cognitive offloading) привела к атрофии навыков: (1) не помнит синтаксис и паттерны -- полагался на автодополнение; (2) не может декомпозировать задачи -- AI делал это за него; (3) код "предвзятый и поверхностный" (цитата MIT) -- не тренировал критическое мышление; (4) не понимает архитектурных решений, которые принимал AI. Разница между здоровой и нездоровой разгрузкой: навык сохранён vs навык атрофирован.

> [!question]- Как использовать AI для усиления мышления, а не его замены?
> Принцип: AI для ускорения рутины -- ок, AI вместо понимания -- когнитивный долг. Конкретно: (1) сначала подумай сам, потом проверь с AI; (2) используй AI как rubber duck -- задавай вопросы, а не проси готовый ответ; (3) для рутинного кода (boilerplate) -- AI допустим, для архитектурных решений -- думай сам; (4) образование как "буфер" -- люди с глубоким пониманием сохраняют критическое мышление даже при активном использовании AI.

---

## Ключевые карточки

Что такое когнитивный долг (cognitive debt)?
?
Термин MIT Media Lab: накапливающийся дефицит когнитивных способностей от чрезмерного использования AI. Измерен через ЭЭГ: группа ChatGPT показала значимо более низкую нейронную активность. 83% не смогли вспомнить содержание своих работ.

Что такое когнитивная разгрузка (cognitive offloading)?
?
Использование внешних инструментов для снижения когнитивной нагрузки (Risko & Gilbert, 2016). Здоровая: навык сохранён, инструмент ускоряет (калькулятор для сложных вычислений). Нездоровая: навык атрофирован, без инструмента парализован (не умеешь считать без калькулятора).

Какова корреляция между использованием AI и критическим мышлением?
?
r = -0.68 (исследование Gerlich, 2025, 666 участников). Цепочка: AI -> когнитивная разгрузка (r = +0.72) -> снижение критического мышления (r = -0.75). Возрастной фактор: 17-25 лет наиболее уязвимы. Образование создаёт защитный "буфер".

Как образование защищает от когнитивной разгрузки?
?
Люди с высшим образованием сохраняли критическое мышление даже при активном использовании AI. Глубокое понимание предмета создаёт "буфер" -- человек может оценить качество ответа AI, заметить ошибки, не принимать всё на веру.

В чём принцип "усиление, а не замена" при работе с AI?
?
AI для рутины (boilerplate, форматирование, поиск синтаксиса) -- ускоряет без потери навыков. AI вместо понимания (архитектура, дизайн, критический анализ) -- создаёт когнитивный долг. Правило: сначала подумай сам, потом проверь с AI.
...
| Углубиться | [[metacognition]] |
| Смежная тема | [[ai-engineering-moc]] |

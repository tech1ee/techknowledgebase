...
> [!question]- Почему изучение шахмат не улучшает математические способности, хотя оба навыка кажутся "логическими"? Что это говорит о far transfer?
> Мета-анализы (Sala & Gobet, 2017) показали: шахматы не переносятся на математику, потому что навыки привязаны к конкретному контексту. Far transfer (перенос между далёкими областями) крайне редок и ненадёжен. Шахматы развивают шахматное мышление (распознавание позиций), а не абстрактную "логику". Для трансфера нужны общие структурные принципы, осознанно извлечённые из контекста.

> [!question]- Разработчик изучил SOLID-принципы на примере Java. Как обеспечить перенос этих знаний на Python-проект?
> Необходима mindful abstraction -- осознанное извлечение принципов из конкретного языка. (1) Сформулировать каждый принцип абстрактно, без привязки к Java-синтаксису. (2) Найти аналогии в Python-экосистеме (duck typing вместо интерфейсов). (3) Практиковаться применять принципы в Python-контексте. (4) Сравнить реализации и осознать, что неизменно (принцип) и что меняется (синтаксис).

> [!question]- Чем Low Road transfer отличается от High Road transfer? Приведите примеры из разработки.
> Low Road -- автоматический перенос в похожих контекстах (переключение между IDE: навыки клавиатуры переносятся без усилий). High Road -- осознанный перенос абстрактных принципов в новый контекст (применение паттерна Observer из Android в React через осознание абстрактного принципа подписки на изменения). Low Road не требует усилий, High Road требует mindful abstraction.
...
Что такое transfer of learning?
?
Применение знаний и навыков, полученных в одном контексте, к новой ситуации. Бывает near transfer (похожие контексты) и far transfer (разные области). Near transfer надёжен, far transfer -- редок и требует осознанного усилия.

Чем near transfer отличается от far transfer?
?
Near transfer -- между похожими контекстами (JavaScript к TypeScript). Far transfer -- между далёкими областями (математика к программированию). Near transfer происходит относительно легко, far transfer требует mindful abstraction и практики.

Что такое mindful abstraction?
?
Осознанное извлечение общих принципов из конкретного опыта. Ключ к High Road transfer. Пример: не просто "знаю паттерн Observer в Java", а "понимаю принцип pub/sub и могу применить в любом контексте".

Что такое Low Road и High Road transfer?
?
Low Road -- автоматический перенос в похожих ситуациях (навык не требует осознания). High Road -- осознанный перенос через абстрагирование принципов. Low Road быстрый но ограниченный, High Road медленный но мощный.

Почему far transfer так сложен?
?
Знания привязаны к контексту получения (context-dependent encoding). Мозг кодирует информацию вместе с контекстом обучения. Для трансфера нужно отделить принцип от контекста, что требует дополнительного когнитивного усилия и осознанной практики.

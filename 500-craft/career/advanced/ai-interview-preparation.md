...
> [!question]- Почему процент AI assistance различается для разных этапов подготовки (30% для DSA, 80% для Research)?
> DSA требует развития собственного алгоритмического мышления -- AI-подсказки на этом этапе создают иллюзию понимания без реального навыка. Research, наоборот, -- рутинная задача по сбору информации, где AI экономит часы на парсинге данных. Чем больше этап зависит от critical thinking, тем ниже оптимальная доля AI.

> [!question]- Ты готовишься к System Design интервью в Google и используешь AI для mock-сессий. Как определить, что ты действительно готов, а не просто выучил ответы AI?
> Готовность проверяется способностью: 1) объяснить trade-offs своими словами без промпта, 2) адаптироваться к follow-up вопросам, которых не было в mock-сессии, 3) предложить альтернативный дизайн и обосновать выбор. Если при смене формулировки вопроса ответ "рассыпается" -- знания поверхностные.

> [!question]- Какой конкретный workflow ты бы применил для подготовки STAR-историй с помощью AI, не теряя authenticity?
> 1. Записать raw experience своими словами (без AI). 2. Использовать AI для структурирования в STAR формат. 3. Попросить AI предложить усиление Result с метриками. 4. Human review: звучит ли как я? 5. Практика вслух без текста. 6. AI mock interviewer с follow-up вопросами. Ключевое: AI улучшает формулировку, но факты и детали -- только твои.

> [!question]- Почему использование AI во время реального интервью (кроме AI-enabled формата) -- стратегическая ошибка, даже если технически не запрещено?
> 1) AI-ответы не персонализированы под контекст вопроса и follow-ups. 2) Задержка при формулировке промптов заметна интервьюеру. 3) Неспособность ответить на уточняющие вопросы выдаёт зависимость от AI. 4) Репутационный риск: компании всё чаще проверяют post-interview. AI-подготовка ценна, AI-подмена на интервью -- disqualifier.

---

## Ключевые карточки

AI Interview Preparation Framework: три фазы?
?
1. Preparation (Resume, Research, Skills Gap) -- AI помогает на 40-80%. 2. Practice (DSA, System Design, Behavioral) -- AI помогает на 30-50%. 3. Interview (Coding, Mock, Feedback) -- AI помогает на 50-80%.

Verification Checklist перед использованием AI-контента?
?
Шесть проверок: 1) Фактически точно о МОЁМ опыте? 2) Могу объяснить своими словами? 3) Сказал бы так в разговоре? 4) Отражает реальные навыки? 5) Выдержу follow-up? 6) Отличимо от чистого AI?

Prompt для анализа резюме -- ключевые элементы?
?
Пять компонентов запроса: ATS compatibility score, missing keywords из JD, bullets без метрик, red flags для рекрутера, top-5 конкретных улучшений. Контекст: роль + компания + JD + резюме.

Anti-pattern использования AI в DSA-подготовке?
?
Нельзя: просить AI решить задачу до попытки, копировать решения без понимания, пропускать "think aloud" практику, полагаться на AI во время реального интервью. Можно: использовать AI для объяснения ПОСЛЕ попытки, практиковать артикуляцию подхода, изучать альтернативы.

Как отличить AI-generated контент от человеческого (Red Flags)?
?
Признаки AI: идеальная грамматика без личности, generic фразы ("leverage", "synergize"), шаблонная структура, метрики без деталей, ответы не выдерживающие follow-up. Humanize: добавить специфику, включить неудачи, разговорный язык, читать вслух.
...
|------------|------|--------|
| Следующий шаг | Библиотека готовых промптов для интервью | [[ai-interview-prompts]] |
| Углубиться | Фундамент подготовки к интервью | [[se-interview-foundation]] |
| Смежная тема | Подготовка к System Design для Android | [[system-design-android]] |

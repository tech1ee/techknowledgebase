...
> [!question]- Pyramid Principle на практике
> Вы готовите email CEO о необходимости миграции инфраструктуры стоимостью $200K. Первый draft начинается с технических деталей: 'Наши EC2 instances устарели, latency p99 выросло...' Перепишите email используя BLUF и Pyramid Principle, начиная с conclusion.

> [!question]- 10 minutes, not 60
> Вы подготовили 30-slide presentation для executive committee. У вас 10 минут (executives перебивают). Как restructure презентацию? Что на первых 3 slides? Что в backup?

## Ключевые карточки

Что такое Pyramid Principle (Minto)?
?
Начинай с conclusion, потом supporting points, потом details only if asked. Anti-pattern: bottom-up ('мы анализировали... нашли... поэтому...'). Pyramid: 'Мы должны сделать X, потому что A, B, C.'

Что такое BLUF?
?
Bottom Line Up Front. Сначала главное, потом детали. Bad: 3 абзаца контекста, потом '$50K нужно'. Good: 'Нужно $50K для миграции. Сэкономит $200K/year. Background: ...'

Назови 7 правил презентации executives.
?
1. 10 min not 60. 2. Start with the ask. 3. Business impact first. 4. No jargon. 5. Anticipate questions. 6. Be concise. 7. 'So what?' test for every point.

Как переводить tech jargon для executives?
?
'Latency' -> 'Page load time'. 'Microservices' -> 'Independent teams'. 'Tech debt' -> 'Accumulated shortcuts slowing delivery'. Business impact, not technical details.

## Куда дальше

| Тип | Ссылка | Описание |
|-----|--------|----------|
| Следующий шаг | [[stakeholder-management]] | Управление аудиторией |
| Углубиться | [[crisis-management]] | Коммуникация в кризис |
| Смежная тема | [[technical-presentations]] | Технические презентации |

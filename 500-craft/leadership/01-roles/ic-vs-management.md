...
> [!question]- Почему переход в management считается career change, а не promotion?
> Management требует принципиально других навыков: вместо coding -- people skills, вместо быстрого feedback loop (код работает/нет) -- медленный (люди растут месяцами), вместо deep work -- 60-80% meetings. Это lateral move в другую профессию с другими метриками успеха.

> [!question]- Senior инженер с 7 годами опыта получил предложение стать EM. Что ему обязательно нужно оценить перед принятием решения?
> Нужно: 1) провести honest self-assessment по чеклистам IC/Management fit, 2) поговорить с реальными Staff Engineers и EM о их работе, 3) проверить наличие IC track (Staff/Principal) в компании, 4) понять compensation на обоих треках, 5) подумать о 5-year horizon, не только следующем шаге.

> [!question]- Как объяснить возврат из management в IC на интервью, чтобы это не воспринималось как failure?
> Говорить в рамках pendulum подхода: "Я получил опыт в обоих треках и хочу максимизировать impact через техническую работу на этом этапе карьеры". Фокус на accumulated perspective и conscious choice, а не на негативных аспектах management.

> [!question]- Почему утверждение "менеджеры зарабатывают больше" является мифом?
> Данные levels.fyi показывают, что TC (Total Compensation) на сравнимых уровнях comparable или даже выше для IC: Staff ($450-600K) vs EM ($400-550K) в Big Tech. IC track через Staff, Principal, Distinguished -- полноценный путь с высокой compensation.

---

## Ключевые карточки

В чём главное различие между IC Track и Management Track?
?
IC Track создаёт impact через технологию (архитектура, код, technical influence), Management Track -- через людей (hiring, coaching, removing blockers). Разные feedback loops, разные типы stress, разные источники удовлетворения.

Что такое Terminal Level и какова его роль в выборе трека?
?
Terminal Level -- уровень, на котором нет expectation дальнейшего роста. В большинстве компаний это Senior (L5). Именно на этом уровне обычно происходит выбор: IC track (Staff, Principal) или Management track (EM, Director).

Какова концепция Engineer/Manager Pendulum?
?
Charity Majors предлагает переключаться между IC и Management каждые 3-5 лет. Каждый swing добавляет perspective: EM опыт делает лучшим IC (empathy, big picture), IC breaks предотвращают skill atrophy.

Какие red flags указывают, что не стоит идти в management?
?
Основные red flags: "Это единственный путь роста" (ищи компанию с IC track), "Хочу больше денег" (TC comparable), "Устал от coding" (burnout решается иначе), "Менеджеры ничего не делают" (серьёзное заблуждение).

Сколько времени проводят в meetings Staff Engineer vs Engineering Manager?
?
Staff Engineer: 30-50% meetings, 20-50% coding. Engineering Manager: 60-80% meetings, 0-20% coding. Это фундаментальное различие в распределении времени определяет ежедневный опыт в каждой роли.
...
|-------------|------|-------|
| Следующий шаг | [[transition-to-management]] | Как осуществить переход в management |
| Углубиться | [[tech-lead-role]] | Hybrid роль как пробная площадка между треками |
| Смежная тема | [[staff-plus-engineering]] | Детали IC track выше Senior уровня |

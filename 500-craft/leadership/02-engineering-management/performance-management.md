...
> [!question]- Почему "sandwich feedback" неэффективен и какая альтернатива лучше?
> Позитив-критика-позитив путает recipient: критика теряется, позитив кажется неискренним. Альтернатива: давать позитивный и конструктивный feedback отдельно, каждый clearly. Если urgent -- дать constructive clearly, без cushioning. Separate conversations для separate types.

> [!question]- Performance review стал сюрпризом для сотрудника. Что EM сделал неправильно?
> Отсутствие continuous feedback. Если review -- сюрприз, значит 1-on-1 проводились без real feedback, проблемы не обсуждались своевременно. Правило: positive feedback -- в течение 24 часов, constructive -- 48 часов, critical -- сразу (private). Weekly notes предотвращают recency bias.

> [!question]- Когда PIP необходим, а когда его использовать нельзя?
> PIP необходим: informal coaching не работает 6+ недель, pattern of underperformance, serious issue (но не immediate termination), нужна legal documentation. Нельзя: первый performance issue, новый сотрудник (<6 мес), issue из-за unclear expectations, уже решено terminate (PIP не должен быть формальностью).

---

## Ключевые карточки

Какова формула SBI для feedback?
?
Situation (конкретный контекст) -> Behavior (наблюдаемое действие, не интерпретация) -> Impact (результат поведения). Пример: "На вчерашнем code review [S] ты отклонил PR без объяснения [B]. Это демотивировало автора и команда не поняла стандарты [I]."

Какие 4 стадии управления underperformance?
?
1) Early Warning -- обсуждение в 1-on-1, 2-4 недели. 2) Formal Conversation -- явный разговор о gap, written follow-up, 4-6 недель. 3) PIP -- formal HR document, specific expectations, 30-60-90 дней. 4) Exit -- если PIP не успешен, termination или mutual separation.

Почему Adobe отменила annual reviews и каков результат?
?
Adobe заменила annual reviews на quarterly check-ins без рейтингов, с focus на expectations + feedback + growth. Manager discretion на compensation. Результат: voluntary turnover снизился на 30%. Урок: можно убрать ratings, но нужна сильная feedback culture.

Что такое recency bias в performance review и как его избежать?
?
Review основан на последних 2-4 неделях, забыты achievements первой половины. Решение: weekly notes после каждого 1-on-1, monthly summary, "brag doc" от самого сотрудника. При review просмотреть ВСЕ notes, не только последние.
...
|-------------|------|-------|
| Следующий шаг | [[hiring-engineers]] | Performance criteria для hiring decisions |
| Углубиться | [[delegation]] | Setting expectations при делегировании |
| Смежная тема | [[giving-feedback]] | Техники обратной связи из раздела Communication |

...
> [!question]- Почему 1-on-1 не должен быть status update meeting?
> Для status есть standup и Jira. 1-on-1 -- это время сотрудника для обсуждения важного для него: challenges, concerns, career growth, feedback. Превращение в status meeting теряет trust-building opportunity и делает встречу поверхностной. Правило 80/20: они говорят 80%, ты -- 20%.

> [!question]- EM регулярно отменяет 1-on-1 "потому что busy". К каким последствиям это приведёт?
> Сигнал "ты не приоритет" разрушает trust. Проблемы копятся, early signals упускаются. Turnover при отсутствии 1-on-1 повышается на 40% (SHRM). Правило: 1-on-1 = священный слот. Единственные причины отмены: PTO, actual emergency, они попросили. "15 минут" лучше чем отмена.

> [!question]- Какие 4 уровня слушания существуют и какой является целевым для 1-on-1?
> Level 1: Downloading (ждёшь очереди говорить -- не подходит). Level 2: Factual (слышишь факты -- минимальный). Level 3: Empathetic (слышишь эмоции и concerns -- целевой). Level 4: Generative (создаёте новое понимание вместе -- идеальный/coaching). Менеджер должен стремиться к Level 3-4.

---

## Ключевые карточки

Какова структура эффективного 1-on-1?
?
[5 min] Opening -- "Что на уме?" Их agenda first. [15-20 min] Their Topics -- challenges, concerns, blockers. Слушать > говорить. [10-15 min] Your Topics -- feedback, context, career. [5 min] Close -- action items, "что-нибудь ещё?".

Какие типы 1-on-1 разговоров существуют?
?
Weekly Regular (80% -- текущие дела, 30 min), Career Development (monthly -- рост, goals, 45-60 min), Feedback Session (as needed -- конкретное поведение, 30 min), Difficult Conversation (as needed -- performance issues, 45-60 min).

Почему никогда нельзя отменять 1-on-1?
?
Сотрудники с регулярными 1-on-1 engaged 3x выше (Gallup). Turnover без 1-on-1 +40% (SHRM). 80% проблем обнаруживаются на 1-on-1 vs 20% случайно (Manager Tools). Регулярность важнее длительности -- короткий 1-on-1 лучше отменённого.

Что делать после каждого 1-on-1?
?
Записать 2-3 ключевых point, action items с owners, темы для follow-up, mood/energy observation. Занимает 2-3 минуты. Огромный ROI при performance reviews -- без записей recency bias неизбежен и patterns не замечаются.
...
|-------------|------|-------|
| Следующий шаг | [[performance-management]] | Как давать feedback и проводить review |
| Углубиться | [[delegation]] | Empowering через 1-on-1 |
| Смежная тема | [[empathetic-listening]] | Углубить навыки слушания для Level 3-4 |

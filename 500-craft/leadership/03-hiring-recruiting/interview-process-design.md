...
> [!question]- Почему structured интервью эффективнее unstructured и какова разница в predictive validity?
> Structured interviews (одинаковые вопросы, scoring rubric) имеют predictive validity 0.51 vs 0.38 для unstructured (Google research). Это потому что consistent criteria снижают bias и позволяют сравнивать кандидатов на одной шкале вместо gut feeling.

> [!question]- Компания проводит 8 раундов интервью. Почему это неэффективно?
> Google research показал: после 4-5 интервью дополнительный signal минимален. Больше раундов = хуже candidate experience, longer time-to-hire (теряешь лучших кандидатов), выше cost per hire. Каждое интервью должно оценивать уникальные competencies без дублирования.

> [!question]- Как минимизировать bias в процессе интервью?
> Structured вопросы (одинаковые для всех), scoring rubric до интервью, independent scoring (не обсуждать до debrief), diverse interview panel, blind resume review где возможно. Debrief по evidence, не по feelings.

---

## Ключевые карточки

Какие компоненты должен содержать structured interview process?
?
Job scorecard (criteria + weights), standardized questions для каждого competency, scoring rubric (1-5 с descriptions), independent evaluation forms, structured debrief с evidence-based discussion.

Почему candidate experience критична?
?
Кандидат оценивает компанию так же как компания оценивает кандидата. Плохой experience = потеря хороших кандидатов + негативный employer brand (Glassdoor reviews). Быстрая обратная связь, уважение к времени, прозрачность процесса -- всё это competitive advantage.

Как проводить эффективный debrief после интервью?
?
Каждый interviewer сдаёт independent written evaluation ДО debrief. Обсуждение по competencies, не по general impressions. Факты и examples, не чувства. Hiring manager принимает решение после всех inputs, но не раньше.
...
|-------------|------|-------|
| Следующий шаг | [[making-offers]] | Как делать и negotiating офферы |
| Углубиться | [[leadership-interviews]] | Интервью на leadership позиции |
| Смежная тема | [[coding-challenges]] | Техники оценки coding skills |

...
> [!question]- Почему плохой найм стоит 1.5-2x годовой зарплаты и как это рассчитывается?
> Включает прямые затраты (рекрутинг, onboarding, severance), косвенные (потерянное время команды, снижение морали, отвлечение менеджера), и opportunity cost (не наняли хорошего кандидата). Плюс 6-12 месяцев до осознания ошибки и ещё 3-6 месяцев на замену.

> [!question]- Почему критерии оценки нужно определять ДО начала интервью, а не после?
> Без предопределённых критериев решение основывается на gut feeling и bias (halo effect, similarity bias). Structured evaluation с одинаковыми вопросами для всех кандидатов повышает signal и снижает bias. Post-hoc рационализация не заменяет evidence-based оценку.

> [!question]- Что значит "hire for trajectory, не только current skills" и когда это уместно?
> Trajectory = способность и желание расти. Кандидат с 70% текущих skills, но высоким learning velocity и motivation может через 6 месяцев превзойти кандидата с 100% skills, но без growth mindset. Особенно уместно для junior/mid позиций и быстрорастущих команд.

---

## Ключевые карточки

Почему hiring -- самое важное решение менеджера?
?
A-players attract A-players, а плохой найм стоит 1.5-2x годовой зарплаты. Одно решение о найме влияет на productivity, morale и culture всей команды на месяцы/годы. Hiring -- multiplier effect в чистом виде.

Какие основные bias мешают при найме?
?
Halo effect (одна сильная сторона затмевает слабые), Similarity bias (нравятся похожие на себя), Recency bias (помнишь последнее интервью), Confirmation bias (ищешь подтверждение первого впечатления). Mitigation: structured interviews, scorecards, multiple interviewers.

Какой формат интервью даёт лучший signal?
?
Structured behavioral interviews (расскажи о реальной ситуации) + work sample tests (реальная задача из работы). Вместе дают лучший predictive validity. Brain teasers и whiteboard coding на абстрактных задачах дают слабый signal.

Сколько интервью достаточно для принятия решения?
?
4-5 интервью достаточно -- больше не добавляет значимого signal (Google research). Каждое интервью должно оценивать конкретные competencies без дублирования. Важнее quality каждого интервью, чем quantity.
...
|-------------|------|-------|
| Следующий шаг | [[interview-process-design]] | Дизайн structured процесса интервью |
| Углубиться | [[sourcing-candidates]] | Где искать кандидатов |
| Смежная тема | [[behavioral-interview]] | Техники behavioral interviews |

...
| Обработка ошибок | [[error-handling-resilience]] | Кросс-доменная связь: паттерны обработки ошибок на уровне кода, дополняющие архитектурные resilience patterns |

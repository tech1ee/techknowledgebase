...
- **Kurose J., Ross K. (2021). Computer Networking: A Top-Down Approach, 8th Edition.** — Академический учебник с глубоким объяснением сетевых протоколов, которые являются предметом диагностики. Главы о TCP, DNS и маршрутизации дают фундамент для понимания того, что именно может ломаться.

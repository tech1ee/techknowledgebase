...
Рекомендуемое соотношение для deep-dive материала:
- **Текст:** 60-70%
- **Код/команды:** 20-25%
- **Схемы/таблицы:** 10-15%

Для reference-материала соотношение другое (больше кода/таблиц), но даже там нужны краткие объяснения.
...
### Длина
1000+ слов. Это deep dive, не краткое введение.

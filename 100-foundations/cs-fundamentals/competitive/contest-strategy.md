...
- **Halim, Halim (2013). "Competitive Programming 3."** — Наиболее практичное руководство по CP. Содержит не только алгоритмы, но и отдельные главы по стратегии контеста, тайм-менеджменту и психологии соревнований. Именно из этой книги пришла концепция структурированного подхода к выбору задач.
- **Skiena (2008). "The Algorithm Design Manual."** — Помимо алгоритмов, книга содержит «War Stories» — реальные истории решения задач, которые развивают стратегическое мышление. Учит не просто знать алгоритмы, а выбирать правильный подход в условиях неопределённости.
- **Laaksonen (2017). "Guide to Competitive Programming."** — Современное руководство на основе CSES problem set. Хорошо структурированная прогрессия от базовых тем к продвинутым, что помогает выстроить roadmap изучения — ключевую часть долгосрочной стратегии роста рейтинга.

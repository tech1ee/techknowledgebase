...
> **Pattern-based learning** — подход к подготовке к coding интервью, основанный на изучении алгоритмических паттернов (а не отдельных задач). Каждый паттерн — это шаблон решения, применимый к целому классу задач.

### Прогрессия сложности

Эффективная подготовка следует принципу **deliberate practice** (Ericsson, 1993): задачи должны быть на границе текущего уровня — не слишком лёгкие (нет обучения) и не слишком сложные (демотивация).

| Этап | Сложность | Цель | Критерий перехода |
|------|-----------|------|-------------------|
| Foundation | Easy (1-2 недели) | Освоить базовые паттерны: Two Pointers, HashMap, Binary Search | Стабильно < 15 мин на Easy |
| Core | Medium (3-4 недели) | Углубить паттерны: DP, Graph, Backtracking, Sliding Window | Стабильно < 25 мин на Medium |
| Advanced | Hard (по необходимости) | Комбинации паттернов, продвинутые структуры | Для L5+/Staff позиций |

### Основные списки задач

| Список | Количество | Время | Фокус |
|--------|-----------|-------|-------|
| **Blind 75** | 75 задач | 4-6 недель | Минимальный покрывающий набор всех паттернов |
| **NeetCode 150** | 150 задач | 8-12 недель | Расширенный Blind 75, видео-разборы |
| **LeetCode Top Interview 150** | 150 задач | 8-12 недель | Официальный список LeetCode |
| **CSES Problem Set** | 300 задач | 12+ недель | CP-ориентированный, теоретическая глубина |

### Метод spaced repetition для алгоритмов

> **Spaced repetition** (Ebbinghaus, 1885) — повторение материала через увеличивающиеся интервалы для переноса из краткосрочной в долгосрочную память.

Применение к LeetCode: после решения задачи — повторить подход (не код) через 1, 3, 7, 14, 30 дней. Записать для каждой задачи: паттерн, ключевая идея, edge cases. Ревизия 10-15 задач занимает 15-20 минут.

**Связанные темы:** [[mock-interview-guide]] (практика в формате интервью), [[common-mistakes]] (типичные ошибки), [[patterns-overview]] (все паттерны), [[problem-solving-framework]] (фреймворк UMPIRE)
...
### Теоретические основы
- **Ericsson, K.A. et al. (1993). "The Role of Deliberate Practice in the Acquisition of Expert Performance."** Psychological Review. — Научное обоснование pattern-based learning: целенаправленная практика на границе способностей эффективнее случайного решения задач.
- **Ebbinghaus, H. (1885). "Uber das Gedachtnis."** — Кривая забывания и принцип spaced repetition, лежащий в основе эффективного повторения решённых задач.
- **Cormen, T. et al. (2009). "Introduction to Algorithms (CLRS)."** — Теоретическая база всех алгоритмических паттернов: доказательства корректности и анализ сложности.

### Практические руководства
- **Halim, S. (2013). "Competitive Programming 3."** — Наиболее полная классификация задач по паттернам. Главы 3-4 покрывают все основные алгоритмические техники с сотнями задач.
- **Skiena, S. (2020). "The Algorithm Design Manual", 3rd Ed.** — Мост между теоретическими алгоритмами и практическим решением задач.
- [NeetCode](https://neetcode.io) — видео-разборы 150 задач с объяснением рассуждений; лучший ресурс для распознавания паттернов
- [Tech Interview Handbook](https://techinterviewhandbook.org) — создатели Blind 75; практические советы по тайм-менеджменту и выбору задач

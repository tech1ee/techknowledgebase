...
> **Mock interview** — симулированное собеседование, воспроизводящее условия реального интервью (time pressure, observer, вербализация мыслей). Является формой **deliberate practice** (Ericsson, 1993), переносящей навыки из контролируемой среды (LeetCode дома) в стрессовую (реальное интервью).

### Метод STAR для behavioral-вопросов

> **STAR** (Situation, Task, Action, Result) — структурированный формат ответа на поведенческие вопросы интервью. Обеспечивает конкретность и измеримость ответа.

| Компонент | Описание | Пример |
|-----------|----------|--------|
| **S**ituation | Контекст ситуации | "В команде из 5 человек мы столкнулись с падением production..." |
| **T**ask | Конкретная задача / роль | "Мне нужно было локализовать причину за 2 часа..." |
| **A**ction | Что конкретно сделал ты | "Я проанализировал логи, нашёл race condition..." |
| **R**esult | Измеримый результат | "Исправил за 1.5 часа, downtime сократился с 4 до 0.5 часов" |

### Фреймворк для технической части

Структура 45-минутного coding interview:

| Фаза | Время | Действия | Оценивается |
|------|-------|----------|-------------|
| Understand | 0-5 мин | Уточнить условие, constraints, edge cases | Коммуникация, аналитика |
| Match & Plan | 5-10 мин | Определить паттерн, обсудить подход | Problem-solving, знания |
| Implement | 10-35 мин | Написать код, объясняя по ходу | Coding skill, think aloud |
| Review | 35-40 мин | Dry run с примером, тестирование | Внимательность, процесс |
| Evaluate | 40-45 мин | Time/space complexity, оптимизация | Теоретические знания |

### Психология стресса на интервью

| Феномен | Описание | Контрмера |
|---------|----------|-----------|
| **Choking under pressure** (Baumeister, 1984) | Снижение производительности из-за самоконтроля | Автоматизация через практику (mock) |
| **Working memory overload** | Think aloud + coding + stress = перегрузка | Чеклисты, фиксированный фреймворк |
| **Silence spiral** | Молчание > 30 сек воспринимается как "застрял" | Вербализовать даже неуверенные мысли |

> **Ключевой инсайт:** mock interview тренирует не алгоритмы (для этого есть LeetCode), а **навык performance under pressure** — способность применять знания в стрессовой ситуации.

**Связанные темы:** [[common-mistakes]] (ошибки, которые предотвращает практика), [[leetcode-roadmap]] (подготовка задач для mock), [[contest-strategy]] (аналогичные навыки тайм-менеджмента), [[problem-solving-framework]] (фреймворк UMPIRE)
...
### Теоретические основы
- **Ericsson, K.A. et al. (1993). "The Role of Deliberate Practice in the Acquisition of Expert Performance."** Psychological Review. — Mock interview как форма deliberate practice: перенос навыков из контролируемой среды в стрессовую.
- **Baumeister, R.F. (1984). "Choking Under Pressure: Self-Consciousness and Paradoxical Effects of Incentives on Skillful Performance."** Journal of Personality and Social Psychology. — Научное объяснение "заморозки" на интервью и методы преодоления через автоматизацию навыков.
- **McDowell, G.L. (2015). "Cracking the Coding Interview", 6th ed.** — Фреймворк STAR для behavioral-вопросов; структура 45-минутного coding interview; раздел "Behind the Scenes" о логике интервьюеров.

### Практические руководства
| # | Источник | Тип | Вклад |
|---|----------|-----|-------|
| 1 | [Pramp](https://pramp.com) | Platform | Free P2P mock interviews |
| 2 | [Interviewing.io](https://interviewing.io) | Platform | Mock с инженерами FAANG |
| 3 | [Tech Interview Handbook](https://www.techinterviewhandbook.org) | Guide | Overall strategy |
| 4 | [Design Gurus](https://www.designgurus.io/blog/mock-interviews-for-software-engineers) | Guide | Mock strategy |
| 5 | [Total Career Solutions](https://www.totalcareersolutions.com/whiteboard-coding-interview-strategies/) | Guide | Whiteboard tips |

...
- Skiena (2020). *The Algorithm Design Manual.* — практический подход к выбору алгоритма сортировки под задачу; раздел о permutation cycles объясняет теоретическую основу Cyclic Sort

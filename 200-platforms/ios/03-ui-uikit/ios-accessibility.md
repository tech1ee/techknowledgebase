...
- Neuburg M. (2023). *iOS 17 Programming Fundamentals with Swift.* — содержит главу по accessibility API в UIKit и SwiftUI, объясняет интеграцию VoiceOver и Dynamic Type с фреймворками Apple

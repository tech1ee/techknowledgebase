...
- WiFi: [[network-physical-layer]]
- Обзор протоколов: [[networking-overview]]
...
*Последнее обновление: 2026-01-09 — Добавлены педагогические секции: 5 аналогий (выбор транспорта для доставки WiFi/Zigbee/NFC/LoRa/Matter, mesh vs star топология, Thread vs Zigbee IPv6 различия, Matter как USB-C для умного дома, LoRa vs Cellular почтовый голубь), 6 типичных ошибок с СИМПТОМ/РЕШЕНИЕ (выбор по хайпу не по задаче, Matter магическая совместимость, Zigbee mesh без роутеров, LoRa для всех задач, NFC как Bluetooth, интерференция 2.4 GHz), 5 ментальных моделей (треугольник IoT ограничений дальность/скорость/энергия, дерево принятия решений, слои IoT стека Matter поверх транспорта, TCO lifecycle стоимости, матрица безопасности IoT протоколов)*

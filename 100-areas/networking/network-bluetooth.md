...
*Добавлены педагогические секции: 5 аналогий (Classic vs BLE как такси vs каршеринг, GATT как ресторанное меню с разделами и блюдами, Advertising как доска объявлений в подъезде, Pairing как знакомство с обменом секретом, Bluetooth Mesh как сеть соседей-передатчиков), 6 типичных ошибок с СИМПТОМ/РЕШЕНИЕ (ожидание мгновенного соединения без state machine, игнорирование Android 12+ permissions, сканирование без остановки battery drain, путаница Classic vs BLE API, забытое MTU согласование обрезание данных, интерференция с Wi-Fi 2.4 GHz), 5 ментальных моделей (спектр энергопотребления Classic→BLE, Client-Server роли в GATT, дерево принятия решений по профилю, lifecycle BLE соединения state machine, таблица совместимости версий)*

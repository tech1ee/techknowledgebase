...
*Последнее обновление: 2026-01-09 — Добавлены педагогические секции: 5 аналогий (поколения как эволюция транспорта 1G-5G, соты как районы города с переиспользованием частот, handover как эстафетная палочка, 5G три сценария eMBB/URLLC/mMTC, network slicing как выделенные полосы на шоссе), 6 типичных ошибок с СИМПТОМ/РЕШЕНИЕ (5G покрытие≠скорость DSS/Sub-6/mmWave, VoLTE vs CSFB качество звонков, NB-IoT vs LoRa скрытая стоимость, 4G latency для реал-тайм, роуминг шок-счета, LTE band compatibility), 5 ментальных моделей (эволюция как решение главной боли поколения, частота как компромисс скорость/дальность/проникновение, архитектура поколений distributed→flat→SBA, latency budget таблица, дерево выбора технологии)*

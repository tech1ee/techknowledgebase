...
### Unlocks
- LCA algorithms (Euler tour + RMQ)
- Range queries optimization
- Binary Lifting
- Heavy-Light Decomposition (использует LCA)
...
| # | Источник | Тип | Вклад |
|---|----------|-----|-------|
| 1 | [CP-Algorithms](https://cp-algorithms.com/data_structures/sparse-table.html) | Reference | Полное руководство |
| 2 | [Brilliant](https://brilliant.org/wiki/sparse-table/) | Wiki | Теория |
| 3 | [Baeldung](https://www.baeldung.com/cs/sparse-tables) | Tutorial | Реализация |
| 4 | [Codeforces](https://codeforces.com/blog/entry/78931) | Blog | O(n) construction |
| 5 | [AlgoTree](https://www.algotree.org/algorithms/sparse_table/) | Reference | Примеры |

---

*Последнее обновление: 2026-01-09 — Добавлены педагогические секции: 2 аналогии (таблица рекордов, idempotent операции), 3 типичные ошибки (использование для суммы, расчёт k, попытка update), 2 ментальные модели (2^k покрывает всё, preprocessing vs query tradeoff)*

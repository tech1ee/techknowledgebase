...
- [[ios-architecture]] - понимание архитектуры iOS
- [[ios-process-memory]] - как работает память в iOS

### Связанные темы
- [[ffi-foreign-function-interface]] - общие концепции FFI
- [[kmp-ios-deep-dive]] - интеграция Kotlin Multiplatform с iOS
- [[ios-compilation-pipeline]] - как компилируется Swift код

### Углублённое изучение
- [[ios-performance-profiling]] - влияние dispatch на производительность
- [[ios-testing]] - тестирование mixed codebases
...
- [Swift.org - Importing Objective-C into Swift](https://www.swift.org/documentation/cxx-interop/)
...
### Книги и статьи
- "Effective Objective-C 2.0" by Matt Galloway - глубокое понимание Runtime
- NSHipster: Objective-C Runtime articles
- Mike Ash's "Friday Q&A" - техническое погружение в Runtime

### Инструменты
- `nm` - просмотр символов в бинарнике (включая mangled names)
- `swift demangle` - раскодирование Swift mangled names
- Hopper Disassembler - анализ скомпилированного кода

...
├─────────────────────────────────────────────────────────────────────────┤
│                                                                          │
│  Prerequisites (изучить ДО этой темы):                                  │
│  ─────────────────────────────────────                                  │
│  • [[ios-code-signing]] - Сертификаты, provisioning profiles,           │
│                           как работает подпись кода                     │
│                                                                          │
│  Next (изучить ПОСЛЕ этой темы):                                        │
│  ────────────────────────────────                                       │
│  • [[ios-ci-cd]] - Автоматизация сборки и дистрибуции,                  │
│                    GitHub Actions, fastlane                             │
│                                                                          │
│  Related (связанные темы):                                              │
│  ─────────────────────────                                              │
│  • [[android-apk-aab]] - Аналог для Android: APK, AAB,                  │
│                          Google Play Console                            │
│                                                                          │
│  Dependency Graph:                                                       │
│  ─────────────────                                                      │
│                                                                          │
│  ┌──────────────────┐                                                   │
│  │ ios-code-signing │ ← Prerequisite                                    │
│  └────────┬─────────┘                                                   │
│           │                                                              │
│           ▼                                                              │
│  ┌──────────────────────────┐                                           │
│  │ ios-app-distribution     │ ← Вы здесь                                │
│  └────────┬─────────────────┘                                           │
│           │                                                              │
│           ▼                                                              │
│  ┌──────────────────┐                                                   │

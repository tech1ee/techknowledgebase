...
- [[android-repository-pattern]] — аналогичный паттерн на Android
- [[clean-architecture-ios]] — место Repository в Clean Architecture
- [[core-data-best-practices]] — локальное хранилище
- [[combine-framework]] — реактивное программирование
- [[async-await-swift]] — современная конкурентность

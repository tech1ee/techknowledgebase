...
- [[os-scheduling]] - Kernel-level планирование потоков в XNU
- [[swift-concurrency]] - async/await и Actor модель
- [[ios-performance-optimization]] - Profiling с Instruments
- [[thread-safety-patterns]] - Locks, Atomics, и синхронизация
- [[ios-memory-management]] - ARC и retain cycles в closures
...
- Swift Evolution proposals для concurrency

---

*Последнее обновление: 2026-01-11*
*iOS 18 | Swift 6 | Xcode 16*
...
### Prerequisites
- [[ios-xcode-fundamentals]] — базовая работа с Xcode перед изучением отладки

### Related
- [[ios-performance-profiling]] — Instruments и профилирование после отладки
- [[ios-process-memory]] — глубокое понимание памяти для memory debugging

### See Also
- [[ios-testing]] — Unit/UI тесты как альтернатива отладке
- [[ios-logging-best-practices]] — Structured logging в production
...
- [objc.io — Debugging](https://www.objc.io/issues/19-debugging/)

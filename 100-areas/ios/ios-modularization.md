...
- [[android-modularization]] - аналогичные принципы для Android с Gradle modules
- [[swift-package-manager]] - детали работы SPM
- [[dependency-injection-ios]] - DI паттерны для модульных приложений
- [[clean-architecture-ios]] - архитектурные принципы
- [[swiftui-architecture]] - MVVM и другие паттерны для SwiftUI
- [[xcode-build-optimization]] - оптимизация времени сборки

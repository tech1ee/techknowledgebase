...
- [[ios-core-data]] — детальный гайд по Core Data и SwiftData
- [[android-data-persistence]] — Room, DataStore, и storage best practices
- [[cross-dependency-injection]] — DI для репозиториев
- [[cross-architecture-patterns]] — Clean Architecture с persistence layer
- [[kmp-sqldelight-guide]] — SQLDelight для Kotlin Multiplatform

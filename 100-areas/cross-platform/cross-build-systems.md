...
- [[ios-xcode-fundamentals]] — Детали Xcode: schemes, configurations, signing
- [[android-gradle-fundamentals]] — Gradle DSL, tasks, plugins в деталях
- [[kmp-project-structure]] — Структура KMP проекта с примерами
- [[ci-cd-mobile]] — CI/CD пайплайны для мобильных приложений
...
**Глубокое погружение:**
- [Understanding Xcode Build System](https://developer.apple.com/videos/play/wwdc2018/415/)
- [Gradle Build Cache Deep Dive](https://docs.gradle.org/current/userguide/build_cache.html)
- [KMP-Native iOS Integration](https://kotlinlang.org/docs/multiplatform-mobile-integrate-in-existing-app.html)

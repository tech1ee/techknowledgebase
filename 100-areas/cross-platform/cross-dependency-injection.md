...
- [[ios-dependency-injection]] — Swinject, Needle, Factory детально
- [[android-dependency-injection]] — Hilt, Koin, Dagger детально
- [[cross-architecture]] — MVVM и Clean Architecture
- [[cross-state-management]] — @State vs StateFlow

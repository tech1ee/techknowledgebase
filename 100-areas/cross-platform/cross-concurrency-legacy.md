...
- [[ios-gcd-deep-dive]] — углублённое изучение GCD, барьеры, semaphores
- [[android-handler-looper]] — внутреннее устройство Handler/Looper/MessageQueue
- [[cross-modern-concurrency]] — Swift Concurrency vs Kotlin Coroutines
- [[cross-threading-pitfalls]] — сборник антипаттернов многопоточности
...
- [Handler/Looper/MessageQueue](https://developer.android.com/reference/android/os/Handler)

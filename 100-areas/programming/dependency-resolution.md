...
- [[build-systems-theory]] — как собираются проекты
- [[ci-cd-pipelines]] — зависимости в CI/CD
...
| # | Источник | Тип | Вклад |
|---|----------|-----|-------|
| 1 | [Gradle Dependency Management](https://docs.gradle.org/current/userguide/dependency_management.html) | Docs | Официальная документация |
| 2 | [npm Dependency Resolution](https://docs.npmjs.com/cli/v10/configuring-npm/package-lock-json) | Docs | npm specifics |
